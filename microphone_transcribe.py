...
def main(project_id: str, location: str, language_code: str, model: str) -> None:
...
if __name__ == "__main__":
    ...
    main(PROJECT_ID, 
      # location="us-central1", language_code="cmn-Hans-CN", model='chirp_2'  ## OK, Not OK - it doesn't respond
      # location="us-central1", language_code="en-US", model='chirp_2' ## OK
      # location="global", language_code="en-US", model='chirp' ## Not OK. Chirp can't support streaming_recognize. Client Option is set correctly. but also it shows error.
      # location="global", language_code="cmn-Hans-CN", model='long' ## Error
      # location="global", language_code="cmn-Hans-CN", model='long' ## OK. Client Option을 설정하니까 오류가 발생함. Global의 경우....
      # location="global", language_code="cmn-Hans-CN", model='chirp' ## Error.  model "chirp" does not exist in the location named "global"
      # location="global", language_code="en-US", model='chirp_2' # Error. 400 The model "chirp_2" does not exist in the location named "global"
      location="global", language_code="cmn-Hans-CN", model='long' 
    )
